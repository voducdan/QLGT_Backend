...
<<<<<<< HEAD
                   select pt.MA_PHUONG_TIEN,kh.TEN_KHACH_HANG,kh.MA_KHACH_HANG,kh.CMND,lpt.TEN_LOAI_PHUONG_TIEN,pt.MA_LOAI_PHUONG_TIEN,pt.SO_PHUONG_TIEN,pt. SO_MAY,NGAY_DANG_KY ,pt. MAU_SON,NHAN_HIEU,pt.DUNG_TICH,BIEN_SO_XE,pt.NGAY_DAU_DANG_KY,GHI_CHU,pt.NGAY_TAO,pt.NGAY_CAP_NHAT,pt.HOAT_DONG
=======
...
>>>>>>> 7bb43c1808e6b502c7d36820f6e7faba30d27ade
					 from DerTable pt
                    ...
                    return new ListView<PhuongTienViewModel>() { Data = query, PrePage=PagePrev,NextPage=PageNext ,CurrPage=PageIndex,LastPage= PageLast};
                }
            }
            return null;
        }
